...
public class Board {
    /* Constants */
    static final int EMPTY = 0, WHITE = 1, WHITE_KING = 2, BLACK = 3, BLACK_KING = 4;

    int[][] board;// board[r][c] is the contents of row r, column c.

    /**
     * Create the board and set it up for a new game (Place pieces).
     */
    Board() {
        board = new int[8][8];
        setUpGame();
     ...
     * <p/>
     * Must send board to client after this.
     */
    void setUpGame() {
